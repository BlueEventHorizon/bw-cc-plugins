...
| **triage-issue** (prototype)                          | Verify the Issue against existing specs, rules and code, rewrite it if wrong, then launch impl-issue when the work can be enumerated as tasks, otherwise propose forge start-requirements | `"triage this issue"`    |
