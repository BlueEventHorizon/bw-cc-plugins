...
| **create-feature-from-markdown-plan**                                                  | Turn a Claude plan-mode Markdown plan into requirements and design docs in one pass (forge's own `{feature}_plan.yaml` is out of scope)                                                                                                                                                                                                                                                                                                                                                                                                           | `"create feature from markdown plan"` |
