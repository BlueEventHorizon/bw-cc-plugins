...
| **黄**   | ユーザーが実行すべきコマンド      | `/forge:update-db-rules` |
...
```bash
echo "Next steps:"
echo -e "  1. Run ${YELLOW}/forge:update-db-rules${NC} for initial ToC generation"
echo -e "  2. Run ${YELLOW}/forge:update-db-specs${NC} for initial ToC generation"
```
