# ADR-002: query-rules / query-specs SKILL の fork 型 SKILL 隔離と read-only 制約
...
- Issue #55: doc-advisor query-rules / query-specs SKILL の fork 型 SKILL が親コンテキストを継承し暴走する
