...
| 作成日   | 2026-08-02                                                                                                                                                                                                                                                             |
| 状態     | 改訂後契約（forge:REQ-013 FNC-1318 / forge:ADR-065）に適合済み。実装着手は headless レビュー往復の実機確認（REQ-015 TBD-001）・権限・メソッドの実機確定（§7 TBD-002 / TBD-003）・**本体側のバックエンド軸実装**（forge:REQ-013 FNC-1318。§5 参照。現時点で未実装）待ち |
