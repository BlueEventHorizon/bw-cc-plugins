...
| 作成日   | 2026-08-02                                                                                                                                                                                                                                  |
| 状態     | **契約への適合が未了**（forge:ADR-067 が可用性検査を追加し履歴復元を契約表へ明記。REQ-015 TBD-008 / TBD-009）。実装着手はこの適合・headless レビュー往復の実機確認（REQ-015 TBD-001）・権限とメソッドの実機確定（§7 TBD-002 / TBD-003）待ち |
