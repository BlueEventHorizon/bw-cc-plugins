...
| ☑ | 50 | TASK-006 | 設計書を正式ディレクトリに移動 | ・docs/specs/next_forge/design/create_skills_orchestrator_design.md を docs/specs/forge/design/ に移動<br>・/create-specs-index を実行して index を更新<br>・next_forge ディレクトリが空なら削除 | DES-010 | TASK-003, TASK-004, TASK-005 | - | `/create-specs-index` が正常完了すること | - |
