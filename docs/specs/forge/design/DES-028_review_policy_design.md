...
| `skills/review/scripts/init_session.py`           | `--files` を session.yaml メタとして保存 (`--section` は不採用のため保存しない)                                                                                                                                                                                                                                                                                                                  |
...
| 対応セクション                | 規定内容                                                                                                                                   |
| ----------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ |
| recommendation 値域           | `fix` / `skip` / `create_issue` の 3 値                                                                                                    |
...
| `plugins/forge/scripts/session/summarize_plan.py`                 | script       | `create_issue` 状態を by_status に追加                                                                                                                                                                                                                                                     |
