...
| `apply_eval.py`              | evaluator 結果 plan.yaml 適用後   | `phase=evaluation_merged`, `phase_status=completed`, `active_artifact=plan.yaml` |
