...
| 判断基準 (§3.2)                                              | 適合                                                                                                                                                                                                                                                                |
| ------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 親 context 漏洩による具体的な実害が記録されている            | **起動経路誤指定の実害**: Issue #32 で `subagent_type: "forge:fixer"` という誤指定が発生。親 context の SKILL.md 記述を汎用 Agent が誤読した起動経路の問題であり、fork 型化（Skill ツール経由）で誤指定経路を物理的に閉鎖できる。本要件 (SUBAGENT-REQ-001) の主動機 |
