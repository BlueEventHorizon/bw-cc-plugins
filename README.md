...
|--------|---------|-------------|
| **forge** | 0.0.13 | AI-powered document lifecycle tool. Create, review, fix, and finalize requirements/design/plan docs and code. |
| **anvil** | 0.0.2 | GitHub operations toolkit. Create PRs, manage issues, and automate GitHub workflows. |
