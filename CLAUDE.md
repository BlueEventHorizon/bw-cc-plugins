...
- **forge** (v0.0.38) — ドキュメントライフサイクルツール。要件定義・設計・計画書の作成、コード・文書レビュー、自動修正に対応
...
| `AGENTS.md` | Codex 向け並行ガイド（CLAUDE.md 更新時は同期検討） |
...
- **AGENTS.md との同期**: CLAUDE.md の構造的変更は `AGENTS.md`（Codex 向け並行ガイド）にも反映を検討する
