...
| COPY 範囲の節          | 供給源（蒸留元）                                                                                                                                                                                                                                                                                                                                                                                                     |
| ---------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| forge 文書規範         | `plugins/forge/docs/` の document_style_guide / spec_design_boundary_spec / spec_priorities_spec / design_principles_spec / adr_principles_spec / frontmatter_format（frontmatter）                                                                                                                                                                                                                                  |
| forge 実装規範         | `plugins/forge/docs/` の additive_development_spec §1–§3 / scope_proportionality_spec、`plugins/forge/skills/start-implement/docs/task_execution_spec.md`、`plugins/anvil/skills/impl-issue/references/`（既存資産優先）、`plugins/anvil/skills/impl-ui/references/`（推測禁止・共用部品・検証の裏取り）。ただし残存確認の条項（改名・語彙改訂後に別名・形式の呼び名も検索し、検索語と範囲を残す）は COPY 範囲が正本 |
