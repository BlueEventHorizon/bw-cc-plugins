#!/usr/bin/env python3
"""
start-design/scripts/find_session.py のテスト

session_manager.py find --skill start-design を透過的に呼び出すラッパーを検証する。
...
WRAPPER_PATH = (REPO_ROOT / 'plugins' / 'forge' / 'skills'
                / 'start-design' / 'scripts' / 'find_session.py')
...
def _load_wrapper():
    spec = importlib.util.spec_from_file_location(
        "_find_session_start_design", WRAPPER_PATH
    )
