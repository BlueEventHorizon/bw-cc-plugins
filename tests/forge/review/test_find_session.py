#!/usr/bin/env python3
"""
review/scripts/find_session.py のテスト

session_manager.py find --skill review を透過的に呼び出すラッパーを検証する。

実行:
  python3 -m unittest tests.forge.review.test_find_session -v
"""
...
WRAPPER_PATH = (REPO_ROOT / 'plugins' / 'forge' / 'skills'
                / 'review' / 'scripts' / 'find_session.py')
...
def _load_wrapper():
    spec = importlib.util.spec_from_file_location(
        "_find_session_review", WRAPPER_PATH
    )
