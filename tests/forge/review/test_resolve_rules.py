#!/usr/bin/env python3
"""
review/scripts/resolve_rules.py のテスト

resolve_doc_structure.py --type rules を透過的に呼び出すラッパーを検証する。

実行:
  python3 -m unittest tests.forge.review.test_resolve_rules -v
"""
...
WRAPPER_PATH = (REPO_ROOT / 'plugins' / 'forge' / 'skills'
                / 'review' / 'scripts' / 'resolve_rules.py')
EXPECTED_TYPE = "rules"
...
def _load_wrapper():
    spec = importlib.util.spec_from_file_location(
        "_resolve_rules_review", WRAPPER_PATH
    )
