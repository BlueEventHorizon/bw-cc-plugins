...
Usage:
    python3 ${CLAUDE_PLUGIN_ROOT}/scripts/create_pending_yaml.py --category rules [--full]
    python3 ${CLAUDE_PLUGIN_ROOT}/scripts/create_pending_yaml.py --category specs [--full]
