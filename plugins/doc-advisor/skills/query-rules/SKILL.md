...
```bash
python3 ${CLAUDE_PLUGIN_ROOT}/scripts/embed_docs.py --category rules --check
```
...
1. Run semantic search:
   ```bash
   python3 ${CLAUDE_PLUGIN_ROOT}/scripts/search_docs.py --category rules --query "{task description}"
   ```
