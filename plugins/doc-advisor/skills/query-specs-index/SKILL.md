---
name: query-specs-index
description: |
  Search the Embedding index to identify specification documents needed
  for a task. Uses semantic search (OpenAI Embedding + cosine similarity)
