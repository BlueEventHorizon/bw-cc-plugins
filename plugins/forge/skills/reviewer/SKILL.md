...
- 旧体系の `review_<perspective>.md` (例: `review_logic.md` / `review_resilience.md` / `review_maintainability.md`) は **完全削除**。perspective_name を suffix に用いない
...
(Codex はリダイレクト、Claude は subagent が Write)。
