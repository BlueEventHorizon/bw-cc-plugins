...
| ADR が他プラグインの設計判断の根拠 | `forge:ADR-001_forge_query_test_flag_policy` を判断の根拠                  |
...
| `ADR-001_forge_query_test_flag_policy.md`   | `forge:ADR-001_forge_query_test_flag_policy`     |
...
| 関連設計 | anvil:DES-025_issue_driven_flow_design, forge:ADR-001_forge_query_test_flag_policy, COMMON-DES-001_skill_base_design |
```
