...
[document_style_guide.md](document_style_guide.md) §5 / §8 の違反に対する severity。レビュアーはここから finding へ転記する。「系統」は同 §5 冒頭の表の系統番号であり、その系統の参照にのみ適用する。

| # | 違反                                                                                          | 系統        | severity    |
| - | --------------------------------------------------------------------------------------------- | ----------- | ----------- |
| 1 | リンク先のファイルが実在しない（リンク切れ）                                                  | (1) (2) (3) | 🔴 critical |
| 2 | 移動・改名・削除した文書を指す参照が他文書に残っている                                        | (1) (2) (3) | 🔴 critical |
| 3 | `SKILL.md` / `agents` / `commands` から `docs/` を相対パスで参照                              | (2)         | 🔴 critical |
| 4 | 見出しアンカーが参照先に実在しない                                                            | (1) (2) (3) | 🟡 major    |
...
4〜7 は到達自体は可能で、解決の手間・曖昧さが残るに留まる。
