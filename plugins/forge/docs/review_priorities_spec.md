...
- 委譲先 principles (severity の SoT): `${CLAUDE_PLUGIN_ROOT}/docs/spec_priorities_spec.md` / `${CLAUDE_PLUGIN_ROOT}/docs/spec_design_boundary_spec.md` / `${CLAUDE_PLUGIN_ROOT}/docs/design_principles_spec.md` / `${CLAUDE_PLUGIN_ROOT}/docs/plan_principles_spec.md`
- 委譲先 principles (FNC-411 addendum merge 完了までの一時参照先): `docs/specs/forge-review/principles/spec_priorities_spec_addendum.md` / `docs/specs/forge-review/principles/spec_design_boundary_spec_addendum.md` / `docs/specs/forge-review/principles/design_principles_spec_addendum.md` / `docs/specs/forge-review/principles/plan_principles_spec_addendum.md`
...
> **注**: 本節の参照経路 (criteria の「SSOT参照」→ 委譲先 principles → 重大度カタログ) は **DES-028 §5.1 の addendum merge 完了後に有効**。merge 完了までは `docs/specs/forge-review/principles/*_addendum.md` 4 件の重大度カタログを **一時 SoT** とする (関連文書欄の「FNC-411 addendum merge 完了までの一時参照先」を参照)。merge 完了時に本節の注記と関連文書欄の一時参照先を削除する責務は本 feature の実装 PR (DES-028 §5.1) に含める。
