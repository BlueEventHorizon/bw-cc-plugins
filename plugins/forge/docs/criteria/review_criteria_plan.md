...
| P1       | [additive_development_spec.md](../additive_development_spec.md)                          | principles | 追加開発ワークフロー (計画書は frontmatter を持たず、`requirements_traceability` 先の要件定義書の `feature_type: temporary-feature` で追加 feature かを判定する [frontmatter_format.md](../frontmatter_format.md) §1.3 / 現在の仕様の所在 §2 / P2 矛盾除外規定の前提を提供) |
